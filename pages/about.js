...
import { Container, Jumbotron, Fade, Row, Col, Image, Alert } from 'react-bootstrap'
    ...
    <Fade appear={true} in={true}>
      <div className="mt-n3">
        <Jumbotron className="mb-0 px-5 py-5 text-center banner" style={{
          ...
          <Container>
            <h1 className="text-light title-text mt-4">The only agency specialised in Stag and Hen parties in Lisbon</h1>
          </Container>
        </Jumbotron>
        <Container>
          <h3 className="text-center pt-5">You will not just party like a local, you can also party with the locals.</h3>
          <p className="pb-5 h4 text-center thin-text">Last Bad Decision is revolutionizing stag and hen weekends, as well as any other group activities in Lisbon giving you the opportunity to engage closely with locals and offering an authentic experience.</p>
          <Row >
            <Col md={{ span: 6, order: "first" }} className="px-4">
              <Image src="/images/about_1.jpg" alt="" fluid />
            </Col>
            <Col className="d-flex flex-column justify-content-center px-4">
              <h2 className="title-text text-info my-2">On-Site Reps</h2>
              <h4>There will always be someone you can count on in case of need.</h4>
            </Col>
          </Row>
          <Row className="mt-4">
            <Col md={{ span: 6, order: "last" }} className="px-4">
              <Image src="/images/about_2.jpg" alt="" fluid />
            </Col>
            <Col className="d-flex flex-column justify-content-center px-4 text-md-right">
              <h2 className="title-text text-info my-2 ">Experts in tailoring</h2>
              <h4>Specialised in giving life to your craziest ideas.</h4>
            </Col>
          </Row>
          <Row className="mt-4">
            <Col md={{ span: 6, order: "first" }} className="px-4">
              <Image src="/images/about_3.jpg" alt="" fluid />
            </Col>
            <Col className="d-flex flex-column justify-content-center px-4">
          ...
          <Row className="mt-4">
            <Col md={{ span: 6, order: "last" }} className="px-4">
              <Image src="/images/about_4.jpg" alt="" fluid />
            </Col>
            <Col className="d-flex flex-column justify-content-center px-4 text-md-right">
