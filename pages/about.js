      ...
      <div className="mt-n3">
        ...
        <Container>
          ...
          <p className="pb-5 h4 text-center thin-text">
            Last Bad Decision is revolutionizing stag and hen weekends, as well
            as any other group activities in Lisbon giving you the opportunity
            to engage closely with locals and offering an authentic experience.
          </p>
          <Row>
